...
As Sheldon explains on Big Bang Theory:
...
int main() {
  ...
  if (results.user_score > results.computer_score) {
    std::cout << "YOU WON!!! YOU DEFEATED A COMPUTER - CONGRATULATIONS!\n";
  }
  else {
    std::cout << "YOU LOST!!! TO A COMPUTER - YOU'VE FAILED HUMANS EVERYWHERE!\n";
  }
